...
namespace CucDiSanVN.Areas.Admin.Controllers
{
    ...
    public class VanBanPhapLuatController : Controller
    {
        ...
        public VanBanPhapLuatController(IContentServices services, ILanguageServices languageService)
        {
        ...
        public ActionResult Index(string _searchKey, int? _parentId, DateTime? _fromDate, DateTime? _toDate, int? _pageIndex)
        {
            ...
            var category = _services.Dropdownlist(0, null, "cvanbanphapluat", _languageId);
            ...
            {
                var model = result.Contents.Select(x => new modelVanBanPhapLuat
                {
            ...
            {
                var model = new List<modelVanBanPhapLuat>();
                return View(model);
            }
        }
        ...
        public ActionResult DetailCategory(int? Id)
        {
            ...
            var category = _services.Dropdownlist(0, entity.Id, "cvanbanphapluat", _languageId);
        ...
        public ActionResult DetailCategory(modelCategories entity)
        {
            ...
            var category = _services.Dropdownlist(0, entity.Id, "cvanbanphapluat", entity.LanguageId);
            ViewBag.ParentId = category.Select(x => new SelectListItem { Text = x.Text, Value = x.Value.ToString() });
            return View(entity);
        }
