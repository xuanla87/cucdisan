...
namespace CucDiSanVN.Areas.Admin.Controllers
{
    ...
    public class ThuTucHanhChinhController : Controller
    {
        ...
        public ThuTucHanhChinhController(IContentServices services, ILanguageServices languageService)
        {
        ...
        public ActionResult Index(string _searchKey, int? _parentId, DateTime? _fromDate, DateTime? _toDate, int? _pageIndex)
        {
            ...
            var category = _services.Dropdownlist(0, null, "cthutuchanhchinh", _languageId);
            ...
            {
                var model = result.Contents.Select(x => new modelThuTucHanhChinh
                {
            ...
            {
                var model = new List<modelThuTucHanhChinh>();
                return View(model);
            }
        }
        ...
        public ActionResult DetailCategory(int? Id)
        {
            ...
            var category = _services.Dropdownlist(0, entity.Id, "cthutuchanhchinh", _languageId);
        ...
        public ActionResult DetailCategory(modelCategories entity)
        {
            ...
            var category = _services.Dropdownlist(0, entity.Id, "cthutuchanhchinh", entity.LanguageId);
            ViewBag.ParentId = category.Select(x => new SelectListItem { Text = x.Text, Value = x.Value.ToString() });
            return View(entity);
        }
